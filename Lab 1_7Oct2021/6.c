/*accept the 2 employee details like empid, empname, empsal from the user. Write the
data to the files. Read the same from the file and display. Give the name of the
employee who has got maximum salary.*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
typedef struct{
...
int main()
{
    ...
    printf("The employee with a better salary: ");
    if(sal1<sal2 )
